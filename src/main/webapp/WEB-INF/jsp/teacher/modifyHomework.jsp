...
<html lang="zh-CN">
  <head>
    ...
    function modifyHomework() {
		document.modifyHomeworkForm.submit();
    }
    </script>
  </head>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">编辑作业</h2>
          <div class="table-responsive">
          <form name="modifyHomeworkForm" class="form-horizontal" action="/teacher/modifyHomework" method="post" target="submitfrm">
          <input type="hidden" name="no" value="${homeworkInfo.no}">
          <table class="table table-bordered">
		    <tbody>
		      ...
		      <tr>
		        ...
		        <td><input name="title" type="text" class="input-xlarge" value="${homeworkInfo.title}"></td>
		      </tr>
		      <tr>
		        <td><label class="control-label" for="input01">作业内容： </label></td>
		         <td><textarea name="task" rows="10" cols="80" >${homeworkInfo.task}</textarea></td>
		      </tr>
		    </tbody>
		  </table>
		  </form>
		  ...
		  <div class="text-left">
            <button type="button" class="btn btn-primary" onclick="modifyHomework()">更新</button>
          </div>
        </div>
      </div>
    </div>
