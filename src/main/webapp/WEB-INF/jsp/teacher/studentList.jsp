  ...
  <head>
    ...
    $(document).ready(function(){
    	$('#classList').change(function(){
    		window.location.href = "/teacher/studentList?classNo="+$(this).children('option:selected').val();
    	})
    });
    </script>
    <script>
	function goAddStudentForm() {
		location.href="/teacher/addStudentForm";
	}
	function deleteStudent(studentId, classNo) {
		if (confirm("确认删除吗?")) {
			location.href="/teacher/deleteStudent?id=" + studentId + "&classNo=" + classNo;
		}
	}
	function goModifyStudentForm(studentId) {
		location.href="/teacher/modifyStudentForm?id=" + studentId;
	}
    </script>
  </head>
